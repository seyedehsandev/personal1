...
export default function Boldp({img="./project-1.png" , title , git , live}) {
  return (
    <div class="project-box lg:w-[900px] md:w-[680px] w-[340px]  flex flex-col items-center gap-6 lg:gap-7 p-5 lg:p-6 rounded-[32px] border border-solid border-gray-300">
